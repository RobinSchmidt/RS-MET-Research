...
\include{Plots/TikZ_Monomials_0-5}
\end{figure}
...
\include{Plots/TikZ_SineAndCosine}
\end{figure}
...
\label{Fig:Line}
\include{Plots/TikZ_LineEquations}
\end{figure}
...
\include{Plots/TikZ_RiemannIntegral}
\end{figure}
...
\include{Plots/TikZ_TaylorPolysSine}
\end{figure}
...
\pgfplotsset{width=19cm,height=6cm}
\include{Plots/TikZ_TaylorPolysCosine}
\end{figure}
...
\include{Plots/TikZ_TaylorPolysExp}
\end{figure}
...
\include{Plots/TikZ_Monomials_0-7_Group}
\end{figure}
...
\include{Plots/TikZ_GaussTimesX_Surf}
\end{figure}
...
\pgfplotsset{width=16cm,height=10cm}
\include{Plots/TikZ_GaussTimesX_Heat}
\end{figure}
...
\include{Plots/TikZ_SaddleWithAxes}
\end{figure}
...
\label{Fig:Torus}
\pgfplotsset{width=16cm,height=10cm}
\include{Plots/TikZ_Torus}
\end{figure}

\begin{figure}[h]
\centering
\caption{Moebius Strip}
\label{Fig:MoebiusStrip}
\pgfplotsset{width=16cm,height=10cm}
\include{Plots/TikZ_MoebiusStrip}
\end{figure}
...
% See: https://tikz.dev/tikz-graphs
...
\pgfplotsset{width=10cm,height=10cm}
\include{Plots/TikZ_GraphCayley}
\end{figure}
...
-I think, to obtain a direction in x,y,z space, one needs to project the gradient (augmented by z=0) 
 onto the tangetial plane? ...figure out! Or maybe the z-coordinate should be equal/proportional to the
 directional derivative of f into the direction of the gradient?
