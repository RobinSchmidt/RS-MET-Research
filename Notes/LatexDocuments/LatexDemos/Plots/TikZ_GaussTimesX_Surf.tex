...
\begin{tikzpicture}
  \begin{axis}
    \addplot3
      [surf, colormap/viridis, faceted color=rsGray20, fill opacity = 1.0,
...
% colorMapBipolar, etc. One can also use fill opacity = 0.5 for making it sem-transparent - but for 
% this plot, this doesn't look so good
