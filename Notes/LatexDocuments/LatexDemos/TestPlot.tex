...
% Finished plots:                                    % Optimal size
%\include{Plots/TikZ_SaddleWithAxes}                  % 18,12..15  try to draw the border
%\include{Plots/TikZ_GaussTimesX_Heat}                % 18,12
%\include{Plots/TikZ_Torus}                           % 18,12
%\include{Plots/TikZ_GraphSetNeumannOrdinals} 
%\include{Plots/TikZ_GraphSetBirthing} 
%\include{Plots/TikZ_GraphBasic} 
%\include{Plots/TikZ_GraphCayley}                     % 10,10 works - but doesn't seem to matter


% Drafts:
%\include{Draft/TikZ_ParabolicPavillon}          % 18,12
\include{Draft/TikZ_DependencyGraphs}
...
%\include{3rdParty/TikZ_MoebiusStrip2}              % 18,10
