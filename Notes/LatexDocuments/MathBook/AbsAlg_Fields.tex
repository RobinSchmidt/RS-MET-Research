...
% Q: Can we use a similar construction to construct a ring from a monoid - like how the integers can
% be constructed from the naturals? See the construction of Z in the section on aximoatic set theory
