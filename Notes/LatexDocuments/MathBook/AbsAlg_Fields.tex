...
Any mathematical structure that satisfies these requirements is a structure in which can do calculations and solve equations in the same way as we are used to from the rational or real numbers. The rational numbers can be seen as the prototypical example of a field after which the %abstraction was modeled. For the 
...
\subsubsection{Algebraic Closure of a Field}
% In an algebraically closed field, we can solve any polynomial equation. In fact, it will always
% factor into precisely $n$ linear factors if $n$ is the degree [VERIFY]. Algebraically closed
% fields are as nice as it gets when the goal is to solve algebraic equations
% C is algebraically closed



\subsubsection{Transcendental Extension of $\mathbb{Q}$}


\subsubsection{Algebraic Extensions of $\mathbb{F}_p$}
...
-But maybe it's instructive nevertheless to point this stuff out 	
