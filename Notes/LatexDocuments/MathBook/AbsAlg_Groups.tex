...
%===================================================================================================
% Maybe make a subsection Taxonomy of Groups:
% Cyclic, Abelian, Alternating, Symmetric, Dihedral
% and this text here should go as subsubsection into it

\subsection{Permutation Groups}
A permutation of a finite set $A = \{ 1,2,\ldots,n \}$ with $n$ elements is an arrangement of its elements. Sets themselves do not have any notion of order, so we denote such an arrangement of the $n$ elements in the form of an $n$-tuple. Let's take the set $A = \{ 1,2,3 \}$ and assume its natural order is $(1,2,3)$. [TODO: introduce notation for permutations]...TBC...
