...
% -Subgroups for which the left and right cosets coincide
% -This can also be stated as: they are invariant under conjugation
% -These are the basis for quotient groups
...
We are now interested in how we can break down certain groups into smaller constituent groups. 
...
% We could also include Coxeter groups here
...
% One of the sporadic groups is so special that some authors do not include it into the class of sporadic groups but rather think of it as being solitarily in a class of its own. That group is the Tits group. I take the stance that if something doesn't even fit into the sporadic groups then it is in some sense extra-sporadic which in my view certainly qualifies as sporadic. 
