...
% Explain how we can interpret the set of cosets as a group and how we can calculuate with these cosets. If we just pick the first element from each coset, we get {0,1,2,3}. Should we interpret that as Z_4? But what if we pck other representatives? Maybe it still works but we need to pick the "corresponding" representatives like 4,5,6,7 or 8,9,10,11? But how can we formalize this correspondence? 
