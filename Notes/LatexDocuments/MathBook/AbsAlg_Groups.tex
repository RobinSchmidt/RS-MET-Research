...
The rotational and reflectional symmetries of regular polygons in $\mathbb{R}$ are examples of a broader class of geometric transformations that for a group under composition, namely the isometries of $n$-dimensional Euclidean spaces $\mathbb{R}^n$. An \emph{isometry} is a transformation the keeps distances unchanged. Distances are defined by a metric and general "iso" means that something is unchanged, hence the name isometry. ...TBC...
