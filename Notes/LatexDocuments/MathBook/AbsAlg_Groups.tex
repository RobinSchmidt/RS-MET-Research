...
A Lie group is a group, whose underlying set may be interpreted as points that live on a manifold. For example, the set of all rotations in 3D may be interpreted as the surface of the unit sphere.
