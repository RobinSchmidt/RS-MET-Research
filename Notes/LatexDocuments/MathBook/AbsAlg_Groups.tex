...
-Algorithm for "multiplying" two groups, given their Cayley tables
 ...
 -I think, we need to form something like the Kronecker product of the matrices? Each element
  ...
  ascending order? Is that enough to uniquely determine an order? Figure out! If not, maybe 
  the third row, or at least part of it, should be ordered too...and so on?
