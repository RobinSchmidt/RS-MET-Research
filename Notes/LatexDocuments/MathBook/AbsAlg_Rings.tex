...
% take as example Z^{2 x 2}


% A product ring has always nonzero zero divisors:
% https://en.wikipedia.org/wiki/Zero_divisor
...
% Is there also a difference of ideals? If not, explain why
