...
% The set is not only closed in the sense that we don't get out of it via the multiplication, it even acts like an "attractor" or "magnet" that sucks everything in.
