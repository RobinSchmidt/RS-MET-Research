...
% The set is not only closed in the sense that we don't get out of it via the multiplication, it
% even acts like an "attractor" or "magnet" that sucks everything in.

% If an element is inside the ideal, then all of its multiples are also inside the ideal.

% Sets of the form $n \mathbb{Z}$ are also ideals in $\mathbb{Z}$ for any $n \in \mathbb{N}^+$
...
\medskip
\begin{tabular}{l l l}
Intersection:  & $I \cap J$& $ = \;\; \{a : a \in I, a \in J\}$  \\
Sum:           & $I + J$   & $ = \;\; \{a + b : a \in I, b \in J\}$  \\
Product:       & $I J$     & $ = \;\; \{\sum_n a_n b_n : a_n \in I, b_n \in J\}$  \\
Quotient:      & $I:J$     & $ = \;\;  \{a : a J \subseteq I\}$  \\
Radical:       & $\sqrt{I}$& $ = \;\; \{ a \in R : (\exists n \in \mathbb{N} :  a^n \in I) \}$  \\
\end{tabular}
\medskip

In words: The intersection of two ideals consists of all their common elements. The sum of two ideals consists of all sums that can be formed from the elements of the ideals $I,J$. The product consists of all finite sums of products $a b$ where $a \in I$ and $b \in J$. The quotient ... [TODO: explain in words]. The radical on an ideal consists of all elements of the ring, some power of which lies in the ideal.

%The intersection of two ideals $I \cap J = \{a : a \in I, a \in J\}$ is again an ideal. The sum of two ideals $I + J = \{a + b : a \in I, b \in J\}$ consists of all sums that can be formed from the elements of the ideals $I,J$ and is again an ideal. The product $I J = \{\sum_n a_n b_n : a_n \in I, b_n \in J\}$ consists of all finite sums of products $a b$ where $a \in I$ and $b \in J$. The quotient is $I:J =  \{a : a J \subseteq I\}$ [TODO: explain in words] and the radical is $\sqrt{I} = \{ a \in R : (\exists n \in \mathbb{N} :  a^n \in I) \}$ [TODO: explain in words]. You may ask yourself, if we have sum product and quotient, then what about the difference? I think, the answer is that if we would define a difference as $I - J = \{a - b : a \in I, b \in J\}$, which may seem natural, then we would obtain the exact same set as for the sum $I + J$  [VERIFY]. so it wouldn't give us anything new.
...TBC...
