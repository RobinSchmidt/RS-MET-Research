...
% ACRS, pg 25: the associatedness relation can be constructed from the divisibility relation by saying that two elements $a,b$ are associated if $a|b$ and $b|a$. Maybe make a small subsection about Divisibility before associatedness. Divisibility itself is a "pre partial order" relation
