...
% TODO: Maybe switch to the convention of using normal (non-bold) letters u,v,w for vectors and grrek letters for scalars. When we later introduce algebras of quaternions and the like, the vector notation seems to be not really suitable anymore
