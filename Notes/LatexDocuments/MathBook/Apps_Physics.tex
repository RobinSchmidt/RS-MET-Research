...
Newtonian mechanics is the classical approach to classical mechanics invented by the famous British physicist and mathematician Isaac Newton himself. Newtonian mechanics predicts, how a particle with mass $m$ will respond to the force $F$ exerted on it. It will respond by changing its state of movement. This is encapsulated in the fundamental law $F = m a$ where $a$ is the acceleration. ...TBC...
