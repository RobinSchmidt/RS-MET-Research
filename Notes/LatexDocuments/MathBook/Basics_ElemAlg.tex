...
% toDo: give formula for sum of multinomial coeffs
% https://en.wikipedia.org/wiki/Multinomial_theorem#Sum_of_all_multinomial_coefficients
% it specializes to 2^n for m = 2 which is also an important factor about binomial coeffs.
% I think, there's also a formula that expresses the multinomial coeffs in terms of binomial coeffs.
% I think, it may be implemented in the codebase...not sure, though.

%...TBC...VERIFY...TODO: explain Pascal's triangle 
% Maybe use substack for the k_i >= 0 conditio. Maybe use product notation in the rhs and sum notation in the lhs
