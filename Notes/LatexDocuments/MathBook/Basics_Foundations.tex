...
%These are the basic and most commen set operations, but there are some more. [TODO: explain symmetric difference, disjoint union, A^B, 2^A, quotient set i.e. set of equivalence classes]
