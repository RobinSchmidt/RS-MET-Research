...
%\begin{comment}
\begin{tikzpicture}
[mydot/.style={circle, fill=lightgray, inner sep=5pt}, >=latex, shorten >= 6pt, shorten <= 3pt]

\node[mydot,                    label={center:1}] (a1) {}; 
\node[mydot, below=0.3cm of a1, label={center:2}] (a2) {}; 
\node[mydot, below=0.3cm of a2, label={center:5}] (a3) {}; 
%\node[mydot, below=of a3, label={center:4}] (a4) {}; 
	
\node[mydot, right=1.5cm of a1, label={center:0}] (b1) {}; 
\node[mydot, below=0.3cm of b1, label={center:2}] (b2) {}; 
\node[mydot, below=0.3cm of b2, label={center:4}] (b3) {}; 
...
\draw (0,-0.75) ellipse (0.5cm and 1.5cm);
%\draw (0,0) ellipse (2cm and 1cm);

\end{tikzpicture}
%\end{comment}
% try to draw it more horizontally, draw ellipses around the sets
