...
\medskip
In addition to these basic and most commen set operations, there are a couple of more, less common ones. [TODO: explain symmetric difference, disjoint union, $A^B$, $2^A$, quotient set i.e. set of equivalence classes, ...]
...
% n-choose-k is the number of subsets with k elements of a set with n elements...right?
