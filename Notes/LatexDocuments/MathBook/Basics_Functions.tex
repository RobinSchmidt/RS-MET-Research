...
% These are equations that establish a relation between function values at different evaluation points (typically 2 or 3 of them). 
...
%   to analytic continuation (if at all)?
%
