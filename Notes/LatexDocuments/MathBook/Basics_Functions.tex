...
\begin{equation}
a_n = \left(  c_n - \sum_{k=0}^{n-1} a_k b_{n-k} \right) / b_0
\end{equation}
...
% what if c = 1, b = 1 + x^2 - what a would we get by deconv? maybe some sort of polynomial approximation of 1 / (1 + x^2)?
