...
% To make clear that this is not so self evident, use a different visualization that is in a sense more representative for the intention of multiplication: use 3 groups of 4 dots like :: :: :: vs 4 groups of 3 dots like :. :. :. :. From that viusulization, it's not immediately obvious anymore that the total count must be the same because humans cannot subitize 12 dots. We can subitize the 3 or 4 groups and the 3 or 4 dots separately and mutliply in our heads - but for that we already assume the commutativity, i.e. we use it rather than show it.
