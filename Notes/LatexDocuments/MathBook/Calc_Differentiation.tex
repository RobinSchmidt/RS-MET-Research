...
Verify this formula with examples symbolically and numerically!
...
%
% Maybe put it before the quotient rule because in the generalized quotient rule, we actually need this
% rule (together with the product rule) to evaluate the (f g^k)^{(n)} expression
...
-basic, higher order, partial, total, implicit, directional, logarithmic, parametric
