...
\paragraph{Notations} 
ToDo: Explain Lagrange ($f'$), Newton ($\dot{f}$), Leibniz ($d/dx$) and operator ($D[f], D f$) notations. Introduce the "evaluated at" notation with the vertical bar on the right.
