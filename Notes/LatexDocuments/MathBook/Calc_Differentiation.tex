...
\end{equation}
But such a definition comes with some caveats. It is indeed equivalent to the forward and backward difference definition, if the function $f$ happens to be differentiable at $x_0$. But if $f$ is not differentiable at $x_0$, it may happen that the limit in the definition using a central difference still exists. So, in contrast to the other definitions above, this definition here may fail to detect non-differentiability of $f$ while the others do "detect" it by way of nonexistence of the required limit. Verify!...TBC...
