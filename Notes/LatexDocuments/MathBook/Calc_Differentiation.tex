...
We could also define the derivative in a way that is not (at least seemingly) opinionated in any way about from which side we approach the point at which we want to differentiate, which is typically denoted as $x_0$ in this variant of the definition:
\begin{equation}
 f'(x_0) = \lim_{x \rightarrow x_0} \frac{f(x) - f(x_0)}{x - x_0}
\end{equation}
I call it "undirected" here just to have some word for it but I made up that word myself and I haven't seen it anywhere else, so it's probably not standard.
