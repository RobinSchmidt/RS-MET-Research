...
3 f''(g(x))  \cdot g''(x)    g'(x)  + 
  f'(g(x))   \cdot g'''(x) 
\end{equation}
For more explanations (including a proof sketch), see ...TBC...ToDo: include bibliography reference to \href{ https://www.youtube.com/watch?v=hAl3b-0N34E}{www.youtube.com/watch?v=hAl3b-0N34E} and verify everything
