...
% Ito's Lemma, Black–Scholes | Part 4 Stochastic Calculus for Quantitative Finance
% https://www.youtube.com/watch?v=h86f8dV1WSM
% -About the Black-Scoles equation - I think, it's a stochastic PDE

% Don't Solve Stochastic Differential Equations 
% https://www.youtube.com/shorts/OUGDlKnRLOI

% Man Who won Every Math Award, While running a Company
% https://www.youtube.com/watch?v=wQbnuzQt2Ms
% -About Martin Hairer and his work on stochastic partial differential equations
...
Some ideas about nonstandard analysis:
-Could we perhaps embed the set of real numbers into the set of real-valued sequences by
 idenitifying a real number r with the sequence that is just constantly r (or maybe alternatively
 with the equivalence class of all sequences that converge to r). Then we could define infinity
 as the equivalence class of all sequences that divege to infinity and define an infinitesimal
 as the equivalence class of all sequences that converge to zero. To distinguish the number zero,
 we may define it as the all zeros sequence. If we define real numbers r to be constnat sequneces,
 we may for technical reasons, define it as the singleton set conatining the constnat sequence, such
 that it is a set of sequences and therefore  has the same data type as infinity or infinitelsimal.
 See: https://www.youtube.com/watch?v=NfohkSuBF8Q  Infinitely Small Numbers | Infinitesimals
