...
% -In some cases, we may use it to compute the areas of geometric figures such as circles and ellipses
...
% -We can use it to compute an error measure between a fcuntion and an approximant (using e.g. least 
%  squares)
...
% -We can use it to combine two functions - for example using a convolution integral.
% -We can use it to compute global properties of the function that we then may want to optimize (like
%  the total curvature, for example)
