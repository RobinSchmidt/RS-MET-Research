...
TODO: introduce mathematical notation for limits and the epsilon-delta definition, explain left and right limits (approaching from below and above)
...
% Your calculus teacher lied to you about limits (here's the proof)
% https://www.youtube.com/watch?v=ZTEF8PF45hM
...
% Only one curve passes through these rational points, but why?
% https://www.youtube.com/watch?v=OuwLcZQsDoY
% -Has an interesting alternative defintion of continuity in terms of being able to pull a limit
%  out of a function application


% A Continuous Function with DISCONTINUOUS Inverse! | FUN Calculus Example!
% https://www.youtube.com/watch?v=Mv0uUSbuD6E
% -f(x) = e^(i \pi x) 
...
The Most Useful Area of Mathematics
https://www.youtube.com/watch?v=FavU_QaY9wA
-There are 7 types of indeterminate forms:
 0/0, 0^0, 1^inf, inf^0, inf*0, inf-inf, inf/inf
-ToDo: Give algorithm to convert them into each other - with special emphasis of converting to
 the 0/0 form because that's the form that is needed for l'Hospital's rule. I think, Mathologer
 has a video about this.


Let's see a different and simpler example of the "staircase paradox" #math #paradox
https://www.youtube.com/watch?v=78RfWBSgpCo
