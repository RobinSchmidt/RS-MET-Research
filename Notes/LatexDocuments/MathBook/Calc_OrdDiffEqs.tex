...
-I think, the rationale is this:
 -Assume we have a linear inhomgenous ODE with const. coeffs, like this:
  ...
  kind into functons of the same kind - and we want to achieve a match between L[g] and f to satisfy
  the ODE. I have never seen an explanation why this ansatz should make sense - textbooks only tend
  to wite: "Do this!" without explaining why it should work. But I think, this could be a plausible
  explanation.
