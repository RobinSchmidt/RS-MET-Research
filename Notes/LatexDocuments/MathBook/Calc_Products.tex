...
...TBC...ToDo: Explain hat this theorem ensures that every \emph{entire function} can be factored in the way, Euler factored the sine function. Explain what "entire functions" are.
