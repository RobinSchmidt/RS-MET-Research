...
% CFEs are a way to represent irrationla numbers as infinite sequences of real numbers. In this respect, they serve a similar purpose as decimal (or binary or hexadecimal etc.) expansions. But they are more natural in the sense that they do not require us to introduce an (arbitrary) basis.
...
% Maybe put this into the "Arithmetic" section
