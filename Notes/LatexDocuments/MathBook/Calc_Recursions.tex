...
\end{tabular}
\end{center}
Apparently both vector components converge to the same value. A value that is somewhere in between the arithmetic and geometric mean of the initial values. ...TBC...
