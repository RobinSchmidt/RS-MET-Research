...
\end{equation}
Another special case with its own name is the one where we set  $a_j = -1, \forall j$. Such a CFE is a so called \emph{Hirzebruch-Jung continued fraction} expansion. 
...
If we have the CFEs of two numbers $x$ and $y$, we can compute the CFEs of $x + y, x - y, x \cdot y, x / y$ with Gosper's algorithm. ...TBC...
