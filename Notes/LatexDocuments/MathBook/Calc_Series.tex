...
% integral test for convergence is an example for such a rule. It can't be applied to an arbitrary
...
% case of the more general concept of sequences. This may be confusing to the beginner.
