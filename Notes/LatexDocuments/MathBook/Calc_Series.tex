...
% Maybe write a litte section about convergence to zero as important special case
...
%\subsubsection{Tests for Convergence and Divergence}
% Majorante/Minorante
...
\subsubsection{Riemann's Reordering Theorem} is a pretty interesting theorem that applies to conditionally convergent series, i.e. series that converge but do not converge absolutely. ...TBC...

% https://en.wikipedia.org/wiki/Riemann_series_theorem

\subsubsection{Summation Methods} ToDo: Cesaro summation, Hölder Summation, ...
