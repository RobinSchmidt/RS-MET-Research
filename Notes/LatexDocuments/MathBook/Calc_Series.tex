...
\label{Eq:FourierSeriesComplex}
 f(x) = \sum_{n=-\infty}^\infty c_n  e^{\i n \omega x}, \qquad
 c_n = \frac{1}{p} \int_0^p f(x) e^{-\i n \omega x}  \, dx
\end{equation}
