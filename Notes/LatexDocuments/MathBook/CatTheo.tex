...
% elements intact, we talk about order isomorphisms, when we are interested in the group structure,
% we talk about group isomorphisms, etc. In some areas of math, the isomorphisms have more special 
% names like homeomorphism (in topology) or isometry (in metric spaces). These terms can be seen as
% "topological isomorphism", "metric isomorphism"
