...
https://www.youtube.com/watch?v=zEyQr43xXx0

Category Theory: An Introduction to Abstract Nonsense
https://www.youtube.com/watch?v=igf04k13jZk

A gentle introduction to category theory     by All Angles
https://www.youtube.com/watch?v=yP2RjVD-cZ0


Category Theory: The Mathematics of Mathematics
https://www.youtube.com/watch?v=jfkeLKjBlQg 


From a pedagogical point of view, I would say, learn set theory ("bottom up") first and when you are finished with building the whole mathematical edifice, take a step back - like a painter stepping away from their painting to see it as a whole - and analyze the whole thing again through the lens of category theory ("top down"). Both ways may give valuable insights. Keeping the analogy with a painting, it is not uncommon for painters to first make a rough sketch/draft with only lines and then  "fill in" the details. Maybe that can be seen as analogous to taking a (preliminary) top-down approach first.
