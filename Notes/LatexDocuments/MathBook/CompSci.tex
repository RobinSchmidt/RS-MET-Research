...
% https://www.youtube.com/watch?v=3iGFUyxthfc
% -Makes the rather interesting point that for some problems, it's quite easy to devise an
%  efficient algorithm that produces the correct result with a probability that is extreeemely 
%  close to 1 when it is still hard to produce an algorithm that is guaranteed to be right all the
%  time. It gives checksums and hash-functions as examples. It's possible but very unlikely that
%  two very long strings of data produce the same checksum. But to be 100% sure that the data is
%  really the same, one would have to compare the very long strings themselves rather than just 
%  the short checksum.


% Der Algorithmus aus dem 2. Weltkrieg, der die Welt veränderte
% https://www.youtube.com/watch?v=HQwHnDJ1idQ
...
% https://www.youtube.com/playlist?list=PLUwpHrdezMHuGDkvc2s058VzdcSBPA4nM
...
Fractions Are Enough to Program Anything (FRACTRAN Explained)
https://www.youtube.com/watch?v=GIPtnEIQCBM


Self-Referential Theories and Mathematical Logic
https://www.youtube.com/watch?v=EVwQsvof7Hw


The Strangest Program in Math
https://www.youtube.com/watch?v=ub4YsayYb-M
-About Langton's Ant, a particular type of cellular automaton
 https://en.wikipedia.org/wiki/Langton%27s_ant
 https://mathworld.wolfram.com/LangtonsAnt.html
 ...well - it doesn't seem to be a cellular automaton after all but rather a 2D Turing machine?

Every Data Structure Explained in 20 Minutes!
...
Compilers
https://www.youtube.com/playlist?list=PL6whQ6CW68oe3tcmFcBLYFQChqwYEaG7_
