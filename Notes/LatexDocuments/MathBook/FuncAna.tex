...
% But then: how could these subjects be put under an umbrella? Maybe higher order calculus in analogy with higher order functions in functional programming?

% OK - this list here
% https://en.wikipedia.org/wiki/List_of_functional_analysis_topics
% does indeed include operator theory. It also lists wavelet transforms whci are similar to
% Fourier transforms and Parseval's identity which is actually one result in Fourier theory.
% So - yeah - I think, we are right to put Fourier and Laplace transforms into thsi chapter.
...
https://www.amazon.com/Handbook-Discrete-Combinatorial-Mathematics-Applications-ebook/dp/B08R15L6TC


What If Functional Analysis Was... Easy... and FUN
https://www.youtube.com/watch?v=Q6WABhOEetI
-Review of the book "Introductory Functional Analysis" by B. Daya Reddy
 -according to the review, it's the best for applied math people



Functional Analysis vs. Linear Algebra – The Infinite-Dimensional SHOCK
https://www.youtube.com/watch?v=SwAzs9YfmJw
