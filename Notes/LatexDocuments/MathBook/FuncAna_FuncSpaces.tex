...
% Introduction to Lp Spaces: Hölder's inequality, Minkowski inequality
% https://www.youtube.com/watch?v=8XTNAJfsais
...
% The Link Between High School Math and Quantum Physics
% https://www.youtube.com/watch?v=FFPXm-tuOt8
% -nice intro to Hilbert spaces
...
Weird spaces where pi = 4
https://www.youtube.com/watch?v=Zjo1ACFm5WI
-About Banach spaces
-Gives a good taxonomy over the relevant function spaces
 -Banach: complete normed space (complele means: every Cauchy sequence converges to an element of the space)
 -Hilbert: complete inner product space -> special Banach space, where parallelogram identity holds

What is a Hilbert Space?
https://www.youtube.com/watch?v=FFPXm-tuOt8


How to Find the Angle Between Two Functions
https://www.youtube.com/watch?v=pM1K6bgv5W4	
