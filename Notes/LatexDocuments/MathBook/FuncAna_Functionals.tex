...
% They lose the main feature that we expect from functions: mapping values to values. But they retain some important other features. Explain which (see Weitz's video aboput the delta function).
...
% ToDo:
% -Explain that for the derivatives of jump dsicontinuities, we see delta functions scaled by the
