...
% ToDo:
% -Before defining the exponential (which involves a sum), define addition of two operators:
%  for operators T,U their sum S=T+U is defined to be the operator that operates as follows on
%  any given function f: S[f] = (T+U)[f] = T[f] + U[f]. Addition is a bivariate function on 
%  operators
% -explain associativity and define sums of operators using summation notation (which is well
%  defined due to this associativity)
...
https://www.youtube.com/watch?v=eKPhMwafp0w
-Discusses interpretation of the expression
      d
  ----------
      d
   d ----
...
https://www.youtube.com/watch?v=b-GpwCGtuwA  Infinite Matrix


Introduce some interesting exmple operators. For example: the "functional square root": It takes
a function f and produces another function g such that g(g(x)) = f(x). It can be generalized to
the functional n-th root.
 
What is a fractional Fourier transform?
https://www.youtube.com/watch?v=DViyFiwRrwY
