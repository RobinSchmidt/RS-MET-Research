...
% Is this also known as "Functional Derivative"? If so, we should preferably use that term (and only mention that it is also called Gateaux derivative)

% See https://www.youtube.com/watch?v=y9ojuz1diD4 at 5:25
...
% Why Lagrangian Mechanics is BETTER Than Newtonian Mechanics
% https://www.youtube.com/watch?v=23Dn1lJ8K1s
...
Einführung in die Variationsrechnung – Euler-Lagrange Gleichung, Brachistochrone (Physik)
https://www.youtube.com/watch?v=35pNGEBSo1w&list=PLdTL21qNWp2YiZaBF9xMb82kSpBc3YnxQ&index=66
-Playlist "Klassische Mechanik"
...
https://www.youtube.com/watch?v=wOs72qoRI68
