...
where also different forms of the line equation are given. The slope $m$, angle $\alpha$ and the $x,y$ intercepts can be computed as: 
\begin{equation}
 \tan(\alpha) = m = \frac{y_2-y_1}{x_2-x_1} = \frac{v_y}{v_x} = -\frac{b}{a}, \quad
 a = x_1 - \frac{y_1}{m}, \; b = y_1 - m x_1, \quad
\end{equation}
The coefficients $A,B,C$ for the implicit form are given by:
\begin{equation}
...
% Maybe drag the formulas for m and alpha aout of the figure. The coeffs in the implcit form
% are: A = y_1 - y_2 = -v_y, B = x_2 - x_1 = v_x, C = x_1 y_2 - x_2 y_1
