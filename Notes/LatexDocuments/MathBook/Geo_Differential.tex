...
How Many Extra Dimensions Do We Need? Embedding and Immersion of Manifolds
https://www.youtube.com/watch?v=HSYhHqI2CnY


Crofton-Formel: Interessante Methode zur Berechnung von Bogenlängen
https://www.youtube.com/watch?v=gGYmUS2tyjk


Mastering Riemannian Curvature: Parallel Transport & Connections
https://www.youtube.com/watch?v=MRU2D6sLpU0
-6:38 (more specifically: 6:50): How ist the geodesic "nearest"? It's tangential to the curve - but 
 only at the point of origin. It doesn't keep being nearest.
-10:13: We are adding a vector emanating from one point on the surface to another vector that 
 emanates from a different point. On a flat plane, there is no problem with the tip-to-tail 
 construction because in this case, we can freely slide around vectors on the plane and they keep
 their length and direction. But on a curved surface? Maybe here it would indeed make sense to keep
 a clear distinction between points and vectors? Maybe we could write something like v_p for a 
 vector v that emanates from a point p. If we want to form v_p + w_q, that would mean that we add 
 some properly "translated" version of w_q (let's call it w_p) to v_p and that would be a vector
 emanating form the tip of v_p? But: where is the tip of v_p on the surface? Maybe it's not even in 
 the surface? Maybe the vector "arrow" would itself have to be a curve segement?


Describing Surfaces Explicitly, Implicitly & Parametrically // Vector Calculus
https://www.youtube.com/watch?v=jZRqCfi5_Uo

The Geometry of Curves: A Visual Introduction to Differential Geometry
https://www.youtube.com/watch?v=wqE4aYUcw44



Euclidean vs. Non-Euclidean Geometry. Similarities and Differences. Spherical & Hyperbolic Geometry.
https://www.youtube.com/watch?v=uxNZBO2BjKE

Differential Geometry: From Curves to Manifolds
https://www.youtube.com/playlist?list=PL2eSPSHrj7mrWT93cJWfgko1-YOYZIMVh
