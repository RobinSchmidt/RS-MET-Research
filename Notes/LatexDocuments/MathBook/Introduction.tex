...
% Explain what it means for two different definitions to be equivalent and why, in such a case, one
% definition may be preferred over the other (for example, because it's closer to our intuition).
% Definitions of a certain property are equivalent when the mutually imply one another.
% An example is here at 21:00:  https://www.youtube.com/watch?v=1QAqxiO8VHM  but that example is
% quite advanced so it doesn't really fit into this early section of the book
...
% Every Type of Mathematics
% https://www.youtube.com/playlist?list=PLtSSWKaCjQZG5fwghzRQ6CiojJBxPJRCw

% All of MATH Explained in 9 minutes
% https://www.youtube.com/watch?v=EJ93L2VIgug

% The Dictionary of Mathematics They Forgot to Teach in School
% https://www.youtube.com/watch?v=VigvYGY35QM

% Every Major Branch of Pure Mathematics (No BS, No Fluff) Explained
% https://www.youtube.com/watch?v=eXRID9wRd6g

% Every Field of Mathematics, Summarized
% https://www.youtube.com/watch?v=xHaicMtdoP8