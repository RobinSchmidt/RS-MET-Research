...
https://www.youtube.com/watch?v=Ezefs1g59ns

What Spheres Tell Us About Higher Dimensions
https://www.youtube.com/watch?v=6lghzIdkKXI
-About fixed points of rotations on nD spheres. If n is odd, there are always rotatations with no fixed
 points. If n is even, there's always at least 1 fixed point. A fixed point of a transformation is
 characterized by the property that it sits on an eigenvector of the trafo with eigenvalue 1.
