...
% Maybe make a subsection about Gaussian Elimination and another one as
% LU as Gauss with Receipts
...
% https://www.youtube.com/watch?v=DBQSVZLWJiY

% Maybe make a subsubsection about Gram-Schmidt Orthogonalization and another one as 
% QR as Gram-Schmidt with Receipts
...
% Jordan Normal Form - Part 1 - Overview [dark version]
% https://www.youtube.com/watch?v=WuVzj9jie84&list=PLBh2i93oe2qtoBYrEIrVaLfEhZTnf7jml&index=5

% Jordan Normal Form - Part 1 - Overview [dark version]
% https://www.youtube.com/watch?v=WuVzj9jie84&list=PLBh2i93oe2qtoBYrEIrVaLfEhZTnf7jml&index=62
...
% https://en.wikipedia.org/wiki/Cholesky_factorization
...
% - The SVD theorem also implies that any matrix can be written as a sum of rank 1 matrices.


% https://en.wikipedia.org/wiki/Proper_orthogonal_decomposition

% https://himpe.science/talks/himpe13_pod.pdf
% TLDR: POD(X) = SVD(X), PCA(X) = SVD(X - mean(X)) 
...
Matrix Decompositions with Geometric and Physical Interpretation
https://www.youtube.com/watch?v=9UxjL1Ibef0
-Volumetric-Deviatoric Decomposition / Flory Decomposition
-Polar Decomposition
