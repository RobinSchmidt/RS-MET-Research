...
% If A is diagonalizable, it is similar to a diagonal matrix. That means, there exists some coordinate system in which the linear transformation represented by A takes the form of an axis-aligned scaling.
