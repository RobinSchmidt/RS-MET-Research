...
% When we apply the product A = S^-1 * D * S to a vector, the righmost matrix S transforms the
% standard basis vectors (1,0,0),(0,1,0),(0,0,1) to the eigenvectors of A because its columns *are*
% the eigenvectors. The columns of a matrix always say, where they map the standar basis vectors to.
