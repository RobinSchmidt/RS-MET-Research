...
The norm of a vector captures its length. The most common norm is the Euclidean norm but there are others as well. On page \pageref{Tab:Norm}, we already abstractly defined some properties that we require from a norm. ...TBC...
...
We define two vectors to be orthogonal, if their dot product is zero. ...TBC...
...
\paragraph{Distance}
As distance between two vectors, we take the norm of their difference....TBC...
