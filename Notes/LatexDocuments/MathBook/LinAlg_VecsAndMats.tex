...
%Another operation between two matrices $\mathbf{A}$ and $\mathbf{B}$ is called \emph{conjugation} of  $\mathbf{A}$ by $\mathbf{B}$. It is defined as: 
