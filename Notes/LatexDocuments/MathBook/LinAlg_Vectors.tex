...
% I guess the eigenvectors  are just mapped via the change of basis S? I.e. b_i = S a_i or maybe
% S^-1 a_i for a_i, b_i eigenvectors of A,B? Verify!
...
% Maybe use C or S instead of P (for conjugation or similarity trafo). wiki uses P, wolfram X
% maybe other sources use P, too - so it seems to be common. S seems also common - maybe let's
% reserve P for permutation matrices
