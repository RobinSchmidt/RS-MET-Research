...
% with values T,F for true,false and with values K,U for known,unknown. That we would have 4 cases:
% KT: known and true, KF: known and false, UT: unknown and true, UF: unknown and false. Then we 
% would make combined truth-knowledge tables like so (for "and")
%
%         AND                  OR
%
%      KT  KF  UT  UF
