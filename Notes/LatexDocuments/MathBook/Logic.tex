...
%\paragraph{Modus Ponens} If $p$ is true and $p$ implies $q$, then $q$ is true: $p, p \then q \Rightarrow q$
% https://en.wikipedia.org/wiki/Modus_ponens

%\paragraph{Modus Tollens} If $q$ is false and $p$ implies $q$ then $p$ is false: $\neg q, p \then q \Rightarrow \neg p$
% https://en.wikipedia.org/wiki/Modus_tollens

\paragraph{Hypothetical Syllogism} If $p$ implies $q$ and $q$ implies $r$ then $p$ implies $r$: $p \then q,  q \then r \Rightarrow p \then r$

%\paragraph{Disjunctive Syllogism} If $p$ is false and $p$ or $q$ is true then $q$ is true: $\neg p, p \vee q \Rightarrow q$

\paragraph{Addition} If $p$ is true then $p$ or $q$ is true: $p \Rightarrow p \vee q$

\paragraph{Simplification} If $p$ and $q$ are true then $p$ is true: $p \wedge q \Rightarrow p$

\paragraph{Conjunction} If $p$ is true and $q$ is true then $p$ and $q$ is true: $p,q \Rightarrow p \wedge q$

\paragraph{Contraposition}
If $p$ implies $q$ then not $q$ implies not $p$: $p \then q \Rightarrow \neg q \then \neg p$
% https://en.wikipedia.org/wiki/Contraposition

%\paragraph{Reductio ad Absurdum} If $p$ implies $q$ and $p$ implies not $q$ then $p$ is false: $p \then q, p \then \neg q \Rightarrow \neg p$
