...
\include{LinAlg_VecsAndMats}     % currently, this file also has subsections that treat matrices
%\include{LinAlg_SystemsOfEqs}  % file does not yet exist
\include{LinAlg_MatrixDecomp}

% I think, Matrix Decompositions should be a section rather than a subsection
...
\include{NumTheo_AlgNums}    % Algebraic number fields
...
% theoretical CompSci should go here, too
