...
% What makes an formula beautiful? It should be profound, i.e. have huge implications, give great inseight. Maybe it should b simple to state but difficult/non-obvious to derive? Should reveal unexpected connections - sometimes between very different fields of mathematics.

% Maybe make the section a Famous Math Bits and the "Beatiful Formulas" a subsection. Maybe have also a subsection with important formulas (formulas that have a lot of practical use but are not necessarily beautiful), famous theorems, famous conjectures
