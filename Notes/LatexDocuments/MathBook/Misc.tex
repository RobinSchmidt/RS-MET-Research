...
% What makes an formula beautiful? It should be profound, i.e. have huge implications, give great inseight. Maybe it should b simple to state but difficult/non-obvious to derive? Should reveal unexpected connections
