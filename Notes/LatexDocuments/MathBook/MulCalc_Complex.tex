...
% Maybe just use something like \bar{v} ot \hat{v}. The bar might be beset because we already use that notation for complex conjugation elsewhere. It's somewhat ugly though, to always carry around that bar
