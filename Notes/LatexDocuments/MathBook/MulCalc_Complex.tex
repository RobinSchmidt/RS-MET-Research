...
\end{equation}
Such a geometric transformation might also be called an \emph{amplitwist}. This term was first suggested by Tristan Needham in his excellent book "Visual Complex Analysis" and I like its descriptiveness. Note also that sich an amplitwist is precisely the sort of transformation that a multiplication by a complex number achieves. That complex number is of course none other than the value of our derivative. ...tbc...
