...
\end{equation}
The name residue stems from the fact that it is the only thing that remains after we do a contour integration around a closed loop around $z_0$. ...TBC...
