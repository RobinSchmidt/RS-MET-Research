...
Let's go back to equation (\ref{Eq:TaylorSeriesMultiDim}) and focus on the expressions $\frac{\partial f}{\partial x_i} h_i$, $\frac{\partial f^2}{\partial x_i x_j} h_i h_j$, etc. Let's define:
\begin{equation}
