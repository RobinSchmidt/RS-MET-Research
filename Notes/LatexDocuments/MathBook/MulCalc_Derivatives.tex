...
\end{equation}	
for some small deviation vector $\mathbf{h}$. If we are in 2D, then this quadratic approximation function will be the locally best fitting paraboloid.
