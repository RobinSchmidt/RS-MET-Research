...
Let's forget about multi indices for a moment and go back to equation (\ref*{Eq:TaylorSeriesMultiDim}) and let's now focus on things like $\frac{\partial f}{\partial x_i} h_i$, $\frac{\partial f^2}{\partial x_i x_j} h_i h_j$, etc. ...TBC...
...
\end{equation}
Whether such a condensed notation is really useful - I don't know. It requires us to be able to dissect it in our heads. I can't do that easily. I mean really - WTF! We are raising a differential operator to the power of a multi-index here! Knowing what that is even supposed to mean legitimately qualifies as rather advanced stuff - at least in my book.
