...
\begin{equation}
 ...
 \begin{pmatrix}
  \frac{\partial f_1}{\partial x_1} (\mathbf{x}_0) & \hdots & \frac{\partial f_1}{\partial x_n} (\mathbf{x}_0) \\
  \vdots & \ddots & \vdots \\
  \frac{\partial f_m}{\partial x_1} (\mathbf{x}_0) & \hdots & \frac{\partial f_m}{\partial x_n} (\mathbf{x}_0)
 \end{pmatrix}
\end{equation}	
is called the Jacobi matrix	of $\mathbf{f}$ at $\mathbf{x}_0$.


...TBC...
%-explain how this matrix represents a linear approximation
