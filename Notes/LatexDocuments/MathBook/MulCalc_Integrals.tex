...
%For example, our region could be bounded left and right by two vertical lines at $x = a$ and $x = b$, i.e. on the $x$-axis we would have constant boundaries defined by the interval $[a,b]$ as before. But 

% First, we need some more general notation ...TBC...
%\begin{equation}
%	I = \iint_R f \, dA 
%\end{equation}
