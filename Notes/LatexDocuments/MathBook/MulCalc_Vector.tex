...
% The One Idea Connecting the Biggest Theorems in Calculus
% https://www.youtube.com/watch?v=v5eGEbJY-nc
...
-At 8:20, it says that the only two meaningful ways to combine two vectors (such as the del 
 operator and the vector field) is the dot-product and the cross-product. These produce the 
 divergence and curl respectively. But what about the Jacobian matrix? I guess, when we want to 
 express that in terms of some sort of product, it would have to be the Kronecker product or 
 tensor product?
