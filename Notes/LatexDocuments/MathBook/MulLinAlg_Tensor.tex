...
% -Exapline where the word tensor comes from. I think, it is from continuum mechanics where they are
%  used to quantify a state of inner tension in a material. ..there are stress- and strain-tensors 
%  that have something to do with that. maybe use _that_ as motivating example. I think, continuum
%  mechanics is perhaps the most intuitive application of tensors.
...
https://www.youtube.com/watch?v=1GwAEnegaRs

Why Matrices Can Be Diagonal — But Tensors Can’t
https://www.youtube.com/watch?v=RxoZqQmHqbY
