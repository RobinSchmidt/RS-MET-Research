...
Maybe draw an analogy between the choice of a number system in mathe (decimal, binary, ternary, etc.) with the choice of a coordinate system and a system of units in physics. Just like physically relevant  quantities should not depend on such an arbitrary choice (which is why we define tensors in the way they are), mathematically relevant properties of numbers should not depend on the choice of the number system which is really just a convention of how write down numbers that has nothing to do with the intrinsic methematical properties of these numbers. But maybe such a discussion should fo into the chapter about philosophy of mathematics. It could sort of fit inot number theory as well because this is the area of math where we deal with numbers - as opposed to functions (as in calculus)
...
Why Number Theory is Hard
https://www.youtube.com/watch?v=i8bn0US_k84
-numbers can be viewed as members of a vector space where the primes are the basis vectors. For
 example 12 = 2*2*3 = 2^2 * 3 = [2,1,0,0,0,...], 10 = 2^1 * 5^1 = [1,0,1,0,0,0,...]. This can
 also be called a factor space
-Adding such vectors produces the product of the represented number
-Multiplying such vectors by a scaler raises the number to tat power
-gcd and lcm correspond to taking element-wise minimum and maximum of the two vectors
-gcd(a,b) * lcm(a,b) = a*b

What is the Riemann Hypothesis REALLY about?
https://www.youtube.com/watch?v=e4kOh7qlsM4
-This video actually gives the formulas needed to create the prime counting function from the
 zeta zeros - it calls it the "Riemann converter" which takes in a complex number and produces
 a "Riemann harmonic" from that.


How to find the Product of all Factors of any Number
https://www.youtube.com/watch?v=cS1yyGIYHKo	
...
A channel devoted to the Riemann Zeta function
https://www.youtube.com/@ZetaExplained/playlists
https://www.youtube.com/playlist?list=PLTcPERDxgHxl0JSuTyMpUVgItmTZbrAET


The Golden Ratio Has a Twin. No One Talks About It.
https://www.youtube.com/watch?v=TEdT66jEoxs

This Is The Most Stubborn Sequence in Math | Recaman's Sequence
https://www.youtube.com/watch?v=_ydLI-JknBg

The Sum Of Twin Prime Reciprocals... Is Finite?
https://www.youtube.com/watch?v=INyC_01SRaA
-About Brun's constant and Brun's sieve

This Could Have Proven The Riemann Hypothesis
https://www.youtube.com/watch?v=ABz9L2miL-I

We Have Been Stuck On This Prime Pattern For 67 Years
https://www.youtube.com/watch?v=Z_MeJNFDPcA
-About Gilbreath's conjecture: If you take the sequence of primes and take differences of arbitrary
 order, the first entry in each of the difference sequences is always 1.

The Infinite Twin Prime Problem
https://www.youtube.com/watch?v=8HBDE-msUjw


Seit 800 Jahren ungelöst: Das älteste Problem der Mathematik
https://www.youtube.com/watch?v=PlNihiG9ucg

Just 9 Numbers Prove an Infinite Theorem
https://www.youtube.com/watch?v=JUuoHRjtBoY
-about the 15 theorem
 https://mathworld.wolfram.com/FifteenTheorem.html
 https://en.wikipedia.org/wiki/15_and_290_theorems
 https://de.wikipedia.org/wiki/15-Satz

Mathematicians accidentally discovered the same number twice
https://www.youtube.com/watch?v=3_fTrG0-Ts8
