...
Any positive natural number $n \geq 1$ can be written as a product of prime numbers in a way that unique up to ordering of the factors. 
\begin{equation}
