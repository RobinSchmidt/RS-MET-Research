...
% extrapolation
% -Maybe curve fitting should also go here? or maybe into some "Numerical Statistics" section
%  ...or not into Numerics at all but rather into a "Data Analysis" section
...
% -to solve implicit eqautions


%===================================================================================================
\subsection{Differentiation}

% Add some numerical differentiation formulas that respect the inverese function rule. See the code
% for experimenting with linfrac interpolation
...
% -may make use of numeric differentiation or automatic differentiation

%---------------------------------------------------------------------------------------------------
\subsubsection{Randomized Methods}

% simulated annealing, genetic algorithms, swarm/ant algorithms
...
% -About symplectic integration methods
