...
% Definitions make it simpler to talk about subjects by introducing terms that can later be used as abbreviations or shortcuts to communicate larger concepts and ideas in a concise way. Definitions belong to the part of mathematics that is invented.


%\subsection{Inventions and Discoveries}
...
https://www.youtube.com/watch?v=veZS3wuXdEE  Mathematicians Killed Infinity, here's why.
-Is about Finitism



https://www.youtube.com/watch?v=rEUX48eZYLo  Infinity Gets Stranger the Deeper You Go


https://www.youtube.com/watch?v=RhA6hnh-peM  Michael Freedman: Compression Is All You Need


Mathematics Keeps Discovering Things That Shouldn't Exist
https://www.youtube.com/watch?v=q5kp9n6id1I


Not Every Truth Has a Proof. Gödel Proved It.
https://www.youtube.com/watch?v=_3n_uLhlGd8

My idea how to interpret this: A statement about natural numbers is true, iff no counterexample exists, i.e. iff no natural number exists that proves the statement to be false. A priori, there's no reason to believe that such an absence of a counterexample should be equivalent to the provability of the statement. Right? The absence might not be due to being "impossible" (as by the rules, i.e. the axioms and logic inference) but due to "chance". Not everything that can happen must happen. Some things could be "allowed" but just don't happen anyway. Just because something is not ruled out by the rules doesn't mean that it must necessarily happen. When it's framed that way, it seems pretty obvious.



8 Terrifying Reasons Scientists Now Think Math Isn't Real
https://www.youtube.com/watch?v=b_FT7H7x00Y
