...
Maybe first make a section about physical units (metrology) and dimensional analysis. See:

The Hidden Link Between Time, Space, and Mass
https://www.youtube.com/watch?v=ZR-1Jol_nUM
...
Talk about deriving "normalized"(?), dimensionless quantities quanttities without any units, Planck units, SI/metric units, imperial units

Maybe this should be a subsection that goes into a general "Introdcution" sections. Other subsections could be: "Modeling the World with Math" or "The Unreasonable Effectiveness..."




Fractal Flows and Tools for Tackling Turbulence | #SoME4
https://www.youtube.com/watch?v=QedNfFCfo2o


The bridge to quantum mechanics
https://www.youtube.com/watch?v=wVqqj6N_7RA
-About canoncial transformations in Hamiltonien mechanics
