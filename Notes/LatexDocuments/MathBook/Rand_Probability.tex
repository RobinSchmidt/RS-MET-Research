...
% If the events A and B are independent, then the joint probability of A and B is just the product
% of the indiviudal probabilities of A and B. For example, if you roll two (distinguishable) dice, like a red 
% and a blue one, and ask: what is the probability that the red die rolls an even number (event A) 
% and the blue die rolls a number less than five (event B), then you would get 
% P(A \intersection B) = P(A) \cdot P(B) = 1/3 * 4/6 = 1/3 * 2/3 = 2/9
