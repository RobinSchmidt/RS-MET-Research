...
% Law of complement:  P(A) = x  <-->   P(not A) = 1-x  ...but what is "not A" in terms of sets?
% An event can either happen or not happen. The probabilities for both scenarios must add up to 1,
% i.e. P(A) + P(not A) = 1. But we really need to define exactly what a "complementary event" is.
% I think, it's \Omega \setminus A
