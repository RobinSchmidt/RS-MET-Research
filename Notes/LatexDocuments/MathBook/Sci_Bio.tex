...
\end{equation}
% The formulas are form here at around 12:30:
...
% https://visualpde.com/  super cool website!
...
% https://www.researchgate.net/publication/226831182_Gierer_A_Meinhardt_H_A_theory_of_biological_pattern_formation_Kybernetik_12_30-_39

%\paragraph{Thomas Model}
% I think, it's only chemistry, not biology
...
\medskip
[Q: From the equations, it does not really look like $f,g$ are both increasing functions of $u$ and decreasing functions of $v$. Figure this out!]


% https://visualpde.com/mathematical-biology/schnakenberg.html
