...
Consider the set product $C = A \times B$ of two sets $A$ and $B$ where we have a strict order relation $<_A$ defined on $A$ and an order relation $<_B$ defined on $B$. We can now define an order relation $<_C$ on $C$ as follows: ...TBC...
