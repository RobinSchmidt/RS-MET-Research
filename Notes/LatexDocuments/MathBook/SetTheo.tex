...
\medskip
TODO: explain how the middle table could also be interpreted as representing the real numbers of the interval $[0,1)$ in binary notation - and how we can conclude from this that the base doesn't matter when the exponent is infinite, i.e. $|2^{\mathbb{N}}| = |10^{\mathbb{N}}|$.
