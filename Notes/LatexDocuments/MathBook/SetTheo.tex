...
%Ruling out such looped recursive element inclusions will later be formalized as the axiom of foundation VERIFY!...TBC...maybe we need also the axiom of restricted comprehension and/or the axiom of pairing?
...
The most basic of all number systems is the system of natural numbers. We can construct the set of natural number from ZF as follows. Given any set $x$, define the successor function as $s(x) = x \cup \{ x \}$. Then we give the names $1,2,3,\ldots$ to the following sets: 
...
%$0 = \emptyset$ , $1 = s(0) = \emptyset \cup \{ \emptyset \} =  \{ \emptyset \}$
...
\paragraph{Addition}...TBC...

\paragraph{Multiplication}...TBC...
