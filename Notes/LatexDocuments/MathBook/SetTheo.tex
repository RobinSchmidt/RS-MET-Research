...
\paragraph{Hereditary Property}
In general, a \emph{hereditary property} is a property of an object that is inherited by all of its subobjects. The meaning of the term subobject depends on the context. In set theory, the subobjects of a set are taken to be its elements.
