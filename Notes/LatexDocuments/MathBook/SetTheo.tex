...
% Idea: if we produce the $b \in B$ this way, couldn't we just add the line with the so produced b to the table? Maybe at the w-th position? It seems like postulating that we can always add such a line feels exactly like postulating the existence of an infinite set as in the axiom of infinity.
