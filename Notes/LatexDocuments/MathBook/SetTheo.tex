...
% Check if we really need to require totla orders or if the defition also applies to posets. If so, state it in terms of posets because that's more general
