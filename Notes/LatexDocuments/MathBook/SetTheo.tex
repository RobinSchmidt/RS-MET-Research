...
%We can use this result to show that the cardinality of the real numbers must also be greater than that of naturals. We do so be constructing a bijection between $\mathcal{P}(\mathbb{N})$ and $\mathbb{R}$. We'll actually first construct a bijection between 

...TBC... introduce the symbol $\mathfrak{c}$ for the size of the continuum, explain that the result holds for any set and its power set (Cantor's theorem)
