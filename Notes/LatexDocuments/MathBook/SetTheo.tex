...
Cardinal numbers are special ordinal numbers. That means the set of cardinal numbers is a subset of the set of ordinal numbers. Their purpose is to quantify the size of a set - finite or infinite.
...TBC...
