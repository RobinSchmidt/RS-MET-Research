...
\usepackage{hyperref}
\usepackage{array}            % For Cayley tables and \tabular envs with column-width specifiers
...
%\newcommand{\vec}[1]{\mathbf{#1}}                % Vectors
%\newcommand{\vtr}[1]{\mathbf{#1}}                 % Vectors
%\newcommand{\vv}[1]{\mathbf{#1}}                 % Vectors
% \vec doesn't work because we already defined the vectorize operation on matrices
% See: https://claude.ai/chat/b8d78e4c-55b3-4baa-89b8-911f75022e2c
...
% Maybe rename to \bigoperator

% This uses the above code to define a big K operator for continued fractions:
