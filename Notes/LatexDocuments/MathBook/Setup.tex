...
% whole text here:
%\newcommand*\xor{\mathbin{\dot{\vee}}}        % exclusive or
%\newcommand*\xor{\mathbin{\oplus}}           % exclusive or
\newcommand*\xor{\mathbin{\veebar}}           % exclusive or
% Maybe we should follow wolfram:
