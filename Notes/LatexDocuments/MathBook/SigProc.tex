...
Fields of math that are relevant for DSP: complex analysis, numerical analysis, probability theory,
integral transforms (in particular Fourier and Laplace), ordinary differential equations, discrete
calculus (difference equations and z-trafo - similar to generating functions?), circuit theory, 
physics ((damped) harmonic oscillator), dynamic systems, polynomials, analytic geometry (I guess - 
when working with spatially distributed sensors like antenna arrays)
