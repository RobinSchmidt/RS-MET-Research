...
\medskip
Both Hamming and Levenshtein distance show that the "space" of all strings can indeed be made into a metric space. We also observe that it can be done in different ways.
