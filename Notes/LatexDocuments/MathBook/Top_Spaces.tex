...
\paragraph{Definition: Convergence} We consider a sequence of points $(p_n)$ in a metric space. We say that the sequence is convergent to a point $x$ if for every $\varepsilon > 0$ there is a $n_0 \in \mathbb{N}$ such that for all $n \geq n_0$, all $p_n$ are inside the $\varepsilon$-ball around $x$. [VERIFY!]
