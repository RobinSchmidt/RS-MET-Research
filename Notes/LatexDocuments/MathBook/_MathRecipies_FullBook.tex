...
%\include{Calc_IntEqs}       % Integral Equations (ToDo: create)
...
\include{AbsAlg_Algebras} 
\include{AbsAlg_Poly} 
\include{AbsAlg_Lattices} 
\include{AbsAlg_Universal} 

\include{OrdTheo} % is now intergrated into SetTheo - ...so obsolete?
...
% -Type theory is the framework first exposed in Bertrand Russel's Principia Mathematica
% -It is (or later became?) strongly intertwined with lamda calculus
% -Predates ZFC set theory, aims to create a systematic foundation of math that doesn't run into
%  paradoces like Russel's paradox
% -one also starts with axioms from which one can prove things

% Was soll HoTT? [Intro to HoTT, No. 0]
% https://www.youtube.com/watch?v=Pu16iodESTU
% -About homotopy type theory
% -First video of this series:
%  https://www.youtube.com/playlist?list=PL245PKGUDdcN9-El9D7DRefwX4c9feiYq
...
Every Branch of Applied Math in 20 Minutes
https://www.youtube.com/watch?v=tUnG8Srr_RA
https://dibeos.net/2025/05/31/every-area-of-applied-math-in-20-minutes/
https://dibeos.net/wp-content/uploads/2025/05/all_branches_applied_math_compressed.pdf


Math for Art:

Math of origami
https://www.youtube.com/playlist?list=PL6CCJHQcukwXAavXRIr16uJ57zudeyVSG
