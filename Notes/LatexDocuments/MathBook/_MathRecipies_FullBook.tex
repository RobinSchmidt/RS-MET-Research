...
% What about "Googology"? Is that part of discrete math, too? It's about fast growing functions that
% typically take natural arguments.
% Examples of fats growing functions:
% -Ackermann, Busy Beavers, Tree, Rayos number, tetration, pentation, ...
