...
-Derive some general features of the Hessian of Polya-potentials. A general 2x2 matrix looks 
 ...
 for producing them. But maybe include them in the table on page 4
 
 1/6*x^6 - 5/2*x^4*y^2 + 5/2*x^2*y^4 - 1/6*y^6
 
-Try to make general statements about the eigenvalues and eigenvectors of the Hessian. 
