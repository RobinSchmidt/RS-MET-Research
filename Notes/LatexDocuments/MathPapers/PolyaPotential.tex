...
%  ...for log it looks complicated - the U,V integrals don't seem to match. Maybe try to
%  integrate -atan(y/x) wrt y instead of -atan2(y,x)
%  ...gives: -1/2*x*(2*y*arctan(y/x)/x - log(y^2/x^2 + 1))
%  integrate log(sqrt(x^2+y^2)) wrt x
%  ...gives:
