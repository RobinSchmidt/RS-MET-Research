...
\paragraph{Positive Integer Powers}
We now want to derive expressions for the Polya vector field and potential a general positive integer power, i.e. for functions of the form $f(z) = z^n$.
