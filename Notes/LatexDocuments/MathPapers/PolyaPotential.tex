...
We now want to look at plots for functions of the form $f(z) = z^n$ for some nonnegative integer $n$. We have already seen that the Polya potential for $f(z) = z^2$ gives us, up to scaling, the monkey saddle $P(x,y) = x^3/ 3 - x y^2$. In general, ...tbc
