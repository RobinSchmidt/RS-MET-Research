...
-Don't use z for the height as in z = P(x,y) when we already use z as argument to f = f(z). The letter z means different things in these two situations which is a clash of notation. Maybe use P instead of z, i.e. write P = P(x,y)
