...
//   Renderings.cpp file at some point. Do the same for other topics! ...OK - I have created the
//   .cpp files for this. Now we must move over the code into the appropriate files. But maybe
//   the math stuff should be further broken down into GeometricAlgebra, DifferentialGeometry,
...
// rename to rsComputeSampledRootSets
template<class T>
